...
-- MAGIC > **_Please Note:_** _Make sure you select a **Manual** schedule since this is a training environment. We don't need this to run periodically and incur additional costs!_
